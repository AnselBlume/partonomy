...
class GrandDataset(torch.utils.data.Dataset):
    '''
    Dataloader for the pre-training dataset - GranD
    '''
    ...
    # TODO: dir_path: /shared/nas/data/m1/jk100/code/OpenAttrLibrary/LISA/dataset/grand/GranD
    # TODO: file formats to look at: proc_caption_grounding_part_X
    '''
    Sample:
    
    '''
    # TODO: file formats to look at: proc_obj_lvl_part_X
    '''
    Sample:
    
    '''
    # TODO: file formats to look at: proc_refer_seg_part_X
    '''
    Sample:
    
    '''
    raise NotImplementedError("GrandDataset is not implemented yet")


########################## Below code is left for reference ########################## 
