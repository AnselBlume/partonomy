...
class HIPIE_IMG(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(str(Path(__file__).parent.parent / 'bert-base-uncased')) # ANSEL
        # self.tokenizer = AutoTokenizer.from_pretrained("./uninext-segm/projects/HIPIE/bert-base-uncased")
