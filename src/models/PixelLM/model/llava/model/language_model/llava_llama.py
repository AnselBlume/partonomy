...
class LlavaLlamaForCausalLM(LlamaForCausalLM, LlavaMetaForCausalLM):
    ...
    def forward(
        ...
        output_per_instance_loss: Optional[bool] = False
        ...
        (   output_image_features,
            ...
            input_ids, attention_mask, past_key_values, labels, images, clip_resize_list
        )
        ...
        if labels is not None:
            ...
            # Flatten the tokens
            loss_fct = CrossEntropyLoss(reduction='none' if output_per_instance_loss else 'mean')
            ...
            if output_per_instance_loss:
                # Average loss over each sequence, ignoring padding tokens/other ignored tokens
                loss = loss.view(labels.size(0), -1)
                mask = (labels[..., 1:] != -100)  # shift_labels shape matches labels[..., 1:]
