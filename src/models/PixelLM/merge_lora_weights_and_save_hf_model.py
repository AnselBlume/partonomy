...
def parse_args(args):
    ...
    parser.add_argument("--save_path", default="/shared/nas2/jk100/partonomy_private/src/models/PixelLM/runs/pixellm-13b", type=str, required=True)
    parser.add_argument("--seg_token_num", default=1, type=int)
    parser.add_argument("--image_feature_scale_num", default=2, type=int)
...
def main(args):
    ...
    if args.seg_token_num*args.image_feature_scale_num == 1:
        ...
        new_tokens = ["[SEG{}]".format(i) for i in range(args.seg_token_num*args.image_feature_scale_num)] + ["[SEG]"]
